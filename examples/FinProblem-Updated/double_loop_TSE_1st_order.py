...
ax.plot(t, T_lower, color="#0C447C", lw=1.8, zorder=3, label="DLTSE lower")
ax.plot(t, T_upper, color="#185FA5", lw=1.8, zorder=3, label="DLTSE upper")
ax.plot(t, T_mid, color="#A32D2D", lw=1.5, ls="--", zorder=4, label="DLTSE midpoint")
...
ax.plot(t, Tvar_lower, color="#0C447C", lw=1.8, zorder=3, label="DLTSE lower")
ax.plot(t, Tvar_upper, color="#185FA5", lw=1.8, zorder=3, label="DLTSE upper")
ax.plot(t, Tvar_mid, color="#A32D2D", lw=1.5, ls="--", zorder=4, label="DLTSE midpoint")
ax.set_xlabel("Time [s]")
