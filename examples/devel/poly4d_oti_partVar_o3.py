...
rv_pdf, lb, ub, rv_mean, mx02, mx03, mx04, mx05, mx06, mx07, mx08, mx09, mx10, mx11, mx12 = \
...
print(f" Expected Value:   {mu1_oti:10.3f}")
print(f" Total Variance:   {mu2_oti:10.3f}")
print(f" central_moment 3: {mu3_oti:10.3f}")
print(f" central_moment 4: {mu4_oti:10.3f}")
print()
...
print(' Relative error:',(Vi_sum-mu2_oti)/mu2_oti)



# Exact moments and Sobol indices
...
var_o3, Si_o3, Vi_o3 = tse_mu.tseVarThird()
mu2_tse = var_o3[0][0]
Si_tse = Si_o3[0][0]
Sij_tse = Si_o3[1][0]
Sijk_tse = Si_o3[2][0]
...
print('Exact partial variances')
print('Vi_tse =', Vi_tse)
print('Vij_tse =', Vij_tse)
print('Vijk_tse =', Vijk_tse)
print()
...
rel_err_Vi = [1-(Vi_oti[d]/Vi_tse[d]) for d in range(n_dim)]
...
dirs  = [1,2,3,4]
delts = [ oti.e(1,order=tse_order_max)-rv_mean[0],
          oti.e(2,order=tse_order_max)-rv_mean[1],
          oti.e(3,order=tse_order_max)-rv_mean[2],
          oti.e(4,order=tse_order_max)-rv_mean[3] ]
